   ...
   struct
      ...
      fun getRawptr t =
         T {args = Vector.new1 t,
            ...
            maySwitchThreads = false,
            modifiesFrontier = true,
            prototype = (Vector.new1 CType.cpointer, SOME CType.cpointer),
            readsStackTop = true,
            return = Type.cpointer (),
            symbolScope = Private,
            target = Direct "GC_getRawptr",
            writesStackTop = true}
                     ...
                     datatype z = datatype Prim.Name.t
                           in
                              case Prim.name prim of
                               ...
                               | CPointer_getRawptr =>
                                    simpleCCall
                                    (CFunction.getRawptr (Operand.ty (a 0)))

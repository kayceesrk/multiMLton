...
datatype 'a t =
 ...
 | CPointer_getRawptr (* ssa to rssa *)
 | MLton_touch (* backend *)
...
fun toString (n: 'a t): string =
   ...
   in
      case n of
       ...
       | MLton_walk => "MLton_walk"
       | MLton_size => "MLton_size"
       | CPointer_getRawptr => "CPointer_getRawptr"
...
val equals: 'a t * 'a t -> bool =
   fn (Array_array, Array_array) => true
    ...
    | (MLton_walk, MLton_walk) => true
    | (MLton_size, MLton_size) => true
    | (CPointer_getRawptr, CPointer_getRawptr) => true
...
val kind: 'a t -> Kind.t =
   ...
   in
      case p of
       ...
       | MLton_walk => SideEffect
       | MLton_size => DependsOnState
       | CPointer_getRawptr => DependsOnState
...
fun 'a checkApp (prim: 'a t,
  ...
  in
      case prim of
       ...
       | MLton_walk => oneTarg (fn t => (oneArg t, unit))
       | MLton_size => oneTarg (fn t => (oneArg t, csize))
       | CPointer_getRawptr =>
            oneTarg (fn t => (oneArg t, cpointer))
...
fun ('a, 'b) extractTargs (prim: 'b t,
   ...
   in
      case prim of
       ...
       | MLton_walk => one (arg 0)
       | MLton_size => one (arg 0)
       | CPointer_getRawptr => one (arg 0)

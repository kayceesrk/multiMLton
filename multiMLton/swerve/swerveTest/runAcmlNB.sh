...
do
    ...
    rm -f ${HOME}/multiMLton/swerve/swerveAcmlNB/www/var/*
    ${HOME}/multiMLton/swerve/swerveAcmlNB/main/main @MLton number-processors ${proc} enable-timer 15000 io-threads ${iot} fixed-heap 2G -- -f ${HOME}/multiMLton/swerve/swerveAcmlNB/www/swerve.cfg &
    sleep ${smallsleep}

    echo "Running httperf..."

    for x in  100 200 300 400 500 600 700 800 900 1000 1100 1200 1300 1400
    do

...
PRIVATE GC_profileData GC_getProfileCurrent (GC_state *gs);
PRIVATE void GC_setProfileCurrent (GC_state *gs, GC_profileData p);

PRIVATE GC_profileData GC_profileMalloc (GC_state *gs);
PRIVATE void GC_profileWrite (GC_state *gs, GC_profileData p, NullString8_t fileName);
PRIVATE void GC_profileFree (GC_state *gs, GC_profileData p);

void GC_profileDisable (void);
void GC_profileEnable (void);

PRIVATE void GC_profileDone (GC_state *gs);

...
struct GC_state {
  ...
  struct UT_Array2* reachable;
  struct CopyObjectMap2* copyObjectMap;
  bool copyImmutable;
  GC_weak weaks; /* Linked list of (live) weak pointers */
  char *worldFile;
  struct UT_Array2* directCloXferArray; /* Array to store closures directly transferred to this core */

...
.PHONE: quick-compiler
quick-compiler:
	rm -f ./build/bin/mlton
	make compiler
	cp ./bin/mlton-script ./build/bin/mlton
	chmod a+x ./build/bin/mlton
	make world
...
LIBRARIES := ckit-lib mlrisc-lib mlnlffi-lib mlyacc-lib smlnj-lib
